import { cipher } from "./k-RailCipher";

const sbox= ["1100","0101","0110","1011","1001","0000","1010","1101","0011","1110","1111","1000","0100","0111","0001","0010"]


const sboxInv = [ "0101", "1110", "1111", "1000", "1100", "0001", "0010", "1101", "1011", "0100", "0110", "0011", "0000", "0111", "1001", "1010"]

const pBox = [0,16,32,48,1,17,33,49,2,18,34,50,3,19,35,51,4,20,36,52,5,21,37,53,6,22,38,54,7,23,39,55,8,24,40,56,9,25,41,57,10,26,42,58,11,27,43,59,12,28,44,60,13,29,45,61,14,30,46,62,15,31,47,63];

const pBoxInv = [0, 4, 8, 12, 16, 20, 24, 28, 32, 36, 40, 44, 48, 52, 56, 60, 1, 5, 9, 13, 17, 21, 25, 29, 33, 37, 41, 45, 49, 53, 57, 61, 2, 6, 10, 14, 18, 22, 26, 30, 34, 38, 42, 46, 50, 54, 58, 62, 3, 7, 11, 15, 19, 23, 27, 31, 35, 39, 43, 47, 51, 55, 59, 63]
...
export function encrypt(plaintext, key, keyLength) {
  if (
    ...
    return () =>
      alert(
        "Please enter a valid Key and Message."
      );
  // xor key
...
// console.log(encrypt("hello there traveler","AAAAAAAAAA", 80));
// console.log('================================')
// console.log(decrypt(encrypt("Hello there traveler","AAAAAAAAAA", 80),"AAAAAAAAAA", 80));
// console.log('================================')
// console.log(encrypt("Hello there traveler","AAAAAAAAAAAAAAAA", 128));
// console.log('================================')
// console.log(decrypt(encrypt("Hello there traveler","AAAAAAAAAAAAAAAA", 128),"AAAAAAAAAAAAAAAA", 128));