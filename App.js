...
const HomeStackScreen = () => (
  <HomeStack.Navigator screenOptions={{ headerShown: false }}>
    ...
    />
    <HomeStack.Screen
      name="CipherInfoScreen"
      component={CipherInfoScreen}
      options={{ title: "Enciphering: More Info" }}
    />
    <HomeStack.Screen
      name="DecipherInfoScreen"
      component={DecipherInfoScreen}
      options={{ title: "Deciphering: More Info" }}
    />
  </HomeStack.Navigator>
);
